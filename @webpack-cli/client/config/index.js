...
module.exports = async () => {
    ...
    if (
        fs.existsSync(
            process.cwd() + '/user-webpack-config/webpack.base.config.js'
        )
    ) {
    ...
    if (
        fs.existsSync(
            process.cwd() + '/user-webpack-config/webpack.dev.config.js'
        )
    ) {
    ...
    if (
        fs.existsSync(
            process.cwd() + '/user-webpack-config/webpack.prod.config.js'
        )
    ) {
